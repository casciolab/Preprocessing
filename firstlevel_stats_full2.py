...
subjects_to_process = open("/Users/Failla/Desktop/PIEC/Scripts/rerunlist_11082017.txt").read()
...
Subjects_RunNumbers = {}
with open ('/Volumes/psr/Failla/PIEC/DesktopBackup/subjectsandruns_confoundex_11-09-17.csv', 'rU') as subject_run_file:
        ...
        for runnumber in runlist:
            ...
            if os.path.exists(funcfile):
                ...
                with open(newTemplateFile, "a") as newTemplate:
                    ...
                    newTemplate.write("set confoundev_files(1) " + '"' + confoundfile + '"' + "\n")
